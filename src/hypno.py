...
#
# 2 topics
# python hypno.py.py -c config.ini -l
#
# 1 topic
# python hypno.py.py -c config.ini -t lfc -l
#
    ...
    def on_data(self, data):
        ...
        try:
            ...
            if B_CALC_SENTI:
                ...
                print('{} [{}]'.format(text[0:150], sent_val))
...
if __name__ == '__main__':
    ...
    if not args['config'] and not args['mode']:
        print ('usage: hypno.py.py [-h] [-m MODE] stream | rest [-c CONFIG] [-t TRACK]')
        sys.exit()
    ...
    if B_LIVECHART and args['live']:
        title = '"' + c_theme + '"'
        if c_no_of_topic == 1:
            cmd = "python liveplot.py -c " + c_config_file + " -r -t " + title + " -n 1"
        else:
            cmd = "python liveplot.py -c " + c_config_file + " -r"
